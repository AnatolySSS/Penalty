...
document.querySelector('button').onclick = function(){
  ...
  if (isNaN(date_court_from)) {
    ...
    text = 'Рассмотрев требования Заявителя о взыскании с ' + nameFO + ' неустойки '+
    ...
    'Заявитель обратился в ' + nameFO + ' с заявлением о наступлении страхового случая '+
    ...
    formatDate(new Date(pay_date[1])) + ' ' + nameFO + ' осуществило выплату страхового возмещения в размере '+
