...
function addFuExpertise() {
	...
	<div class="form-row">
	  ...
	  <div class="form-group col-md-4">
		<input id = "fu_expertise_orgainzation_${fuExpertiseId}" class="fu_expertise_orgainzations li-quotes form-control" placeholder="Наименование экспертной организации" type="text" size="8" required>
	  </div>
