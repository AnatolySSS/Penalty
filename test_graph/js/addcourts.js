...
function addCourt() {
  ...
  var str = '<div id="court_' + courtId + '">' +
    ...
    '<div class="form-group col-md-4">' +
      '<input id="court' + courtId + '_name" class="courts_names form-control" type="text" placeholder="Наименование суда" size="40">' +
    '</div>' +
    '<div class="form-group col-md-3">' +
      '<div class="input-group">' +
        '<input id="court' + courtId + '_number" class = "courts_numbers form-control" placeholder="Номер" type="text" size="10">' +
    ...
    '<div class="form-group col-md-2">' +
      '<input id = "court' + courtId + '_date" class = "courts_dates datepicker-here form-control" placeholder="Дата" type="text" size="8">' +
    '</div>' +
    ...
    '</div>' +
    '<div class="form-group col-ms-1">' +
      '<button id="court_btn_' + courtId + '" class="btn btn-outline-danger" onclick="removeCourt(' + courtId + ')">×</button>' +
    '</div>' +
  '</div><!-- court_form_row_1 -->' +
	'<div id="add_court_info_' + courtId + '" style="display:none">' +
	'<div id="add_court_info_row_' + courtId + '_1" class="add_court_info form-row">' +
		'<div class="form-group col-md-4 form-inline">' +
			'<select id="court_claim_' + courtId + '_1" class="court_claims custom-select col-md-12">' +
		...
		'<div class="form-group col-md-3">' +
			'<div class="input-group">' +
				'<input id="court_claim_summ_' + courtId + '_1" class = "court_claim_summs input-numeral form-control" placeholder="Сумма" type="text" size="10">' +
				'<div class="input-group-append">' +
					'<span class="input-group-text">&#8381;</span>' +
				'</div>' +
			'</div>' +
		'</div>' +
		'<div class="form-group col-ms-1">' +
			'<button id="court_claim_btn_' + courtId + '_1" class="btn btn-outline-warning" onclick="addClaim(' + courtId + ')">+</button>' +
		'</div>' +
	'</div><!-- add_court_info_row_1 -->' +
	'<div id="add_court_claim_info_' + courtId + '_1" class="form-group" style="display:none">' +
		'<div class="form-group">' +
			'<h6>Период неустойки</h6>' +
		'</div>' +
		'<div class="form-group form-inline">' +
			'<label for="date_court_from_' + courtId + '_1">c</label>' +
			'<input id = "date_court_from_' + courtId + '_1" class = "ml-2 datepicker-here form-control" placeholder="Дата" type="text" size="8">' +
			'<label for="date_court_to_' + courtId + '_1" class="ml-2">по</label>' +
			'<input id = "date_court_to_' + courtId + '_1" class = "ml-2 datepicker-here form-control" placeholder="Дата" type="text" size="8">' +
			'<input id="court_without_period_' + courtId + '_1" class="ml-2" type="checkbox" onclick="block_court_date(' + courtId + ', 1)">' +
	...
	$('#courts').append(str);
	$('#court' + courtId + '_date').datepicker();
	$('#date_court_from_' + courtId).datepicker();
	$('#date_court_to_' + courtId).datepicker();
...
function addClaim(id) {
  ...
  var str = '<div id="add_court_info_row_' + id + '_' + claimId + '" class="add_court_info_' + id + ' add_court_infos form-row">' +
		...
		'</div>' +
	'</div><!-- add_court_info_row_1 -->' +
	'<div id="add_court_claim_info_' + id + '_' + claimId + '" class="add_court_claim_info_' + id + ' form-group" style="display:none">' +
		'<div class="form-group">' +
			'<h6>Период неустойки</h6>' +
		'</div>' +
		'<div class="form-group form-inline">' +
			'<label for="date_court_from_' + id + '_' + claimId + '">c</label>' +
			'<input id = "date_court_from_' + id + '_' + claimId + '" class = "date_court_from_' + id + ' date_court_froms ml-2 datepicker-here form-control" placeholder="Дата" type="text" size="8">' +
			'<label for="date_court_to_' + id + '_' + claimId + '" class="ml-2">по</label>' +
			'<input id = "date_court_to_' + id + '_' + claimId + '" class = "date_court_to_' + id + ' date_court_tos ml-2 datepicker-here form-control" placeholder="Дата" type="text" size="8">' +
