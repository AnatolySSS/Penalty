...
export function findLastClaimFoDay(date, number_fo_days) {
    ...
    if (date != Date.parse(new Date(2016, 1, 20, 0)) &&
        ...
        while (new Date(date).getDay() == 6 ||
                ...
                date == Date.parse(new Date(2015, 0, 1, 0)) ||
                ...
                date == Date.parse(new Date(2020, 2, 30, 0)) ||
                date == Date.parse(new Date(2020, 2, 31, 0)) ||
                date == Date.parse(new Date(2020, 3, 1, 0)) ||
                date == Date.parse(new Date(2020, 3, 2, 0)) ||
                date == Date.parse(new Date(2020, 3, 3, 0)) ||
                date == Date.parse(new Date(2020, 3, 4, 0)) ||
                date == Date.parse(new Date(2020, 3, 5, 0)) ||
                date == Date.parse(new Date(2020, 3, 6, 0)) ||
                date == Date.parse(new Date(2020, 3, 7, 0)) ||
                date == Date.parse(new Date(2020, 3, 8, 0)) ||
                date == Date.parse(new Date(2020, 3, 9, 0)) ||
                date == Date.parse(new Date(2020, 3, 10, 0)) ||
                date == Date.parse(new Date(2020, 3, 11, 0)) ||
                date == Date.parse(new Date(2020, 3, 12, 0)) ||
                date == Date.parse(new Date(2020, 3, 13, 0)) ||
                date == Date.parse(new Date(2020, 3, 14, 0)) ||
                date == Date.parse(new Date(2020, 3, 15, 0)) ||
                date == Date.parse(new Date(2020, 3, 16, 0)) ||
                date == Date.parse(new Date(2020, 3, 17, 0)) ||
                date == Date.parse(new Date(2020, 3, 18, 0)) ||
                date == Date.parse(new Date(2020, 3, 19, 0)) ||
                date == Date.parse(new Date(2020, 3, 20, 0)) ||
                date == Date.parse(new Date(2020, 3, 21, 0)) ||
                date == Date.parse(new Date(2020, 3, 22, 0)) ||
                date == Date.parse(new Date(2020, 3, 23, 0)) ||
                date == Date.parse(new Date(2020, 3, 24, 0)) ||
                date == Date.parse(new Date(2020, 3, 25, 0)) ||
                date == Date.parse(new Date(2020, 3, 26, 0)) ||
                date == Date.parse(new Date(2020, 3, 27, 0)) ||
                date == Date.parse(new Date(2020, 3, 28, 0)) ||
                date == Date.parse(new Date(2020, 3, 29, 0)) ||
                date == Date.parse(new Date(2020, 3, 30, 0)) ||
                date == Date.parse(new Date(2020, 4, 1, 0)) ||
                date == Date.parse(new Date(2020, 4, 4, 0)) ||
                date == Date.parse(new Date(2020, 4, 5, 0)) ||
                date == Date.parse(new Date(2020, 4, 6, 0)) ||
                date == Date.parse(new Date(2020, 4, 7, 0)) ||
                date == Date.parse(new Date(2020, 4, 8, 0)) ||
                ...
                date == Date.parse(new Date(2021, 4, 4, 0)) ||
                date == Date.parse(new Date(2021, 4, 5, 0)) ||
                date == Date.parse(new Date(2021, 4, 6, 0)) ||
                date == Date.parse(new Date(2021, 4, 7, 0)) ||
                date == Date.parse(new Date(2021, 4, 10, 0)) ||
                date == Date.parse(new Date(2021, 5, 14, 0)) ||
                date == Date.parse(new Date(2021, 10, 1, 0)) ||
                date == Date.parse(new Date(2021, 10, 2, 0)) ||
                date == Date.parse(new Date(2021, 10, 3, 0)) ||
